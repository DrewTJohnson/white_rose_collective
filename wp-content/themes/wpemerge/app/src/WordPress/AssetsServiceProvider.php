...
class AssetsServiceProvider implements ServiceProviderInterface
{
	...
	public function enqueueFrontendAssets() {
		...
		// Enqueue scripts.
		\DaisyBootstrap::core()->assets()->enqueueScript(
			'theme-js-bundle',
			\DaisyBootstrap::core()->assets()->getBundleUrl( 'frontend', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \DaisyBootstrap::core()->assets()->getBundleUrl( 'frontend', '.css' );

		if ( $style ) {
			\DaisyBootstrap::core()->assets()->enqueueStyle(
				'theme-css-bundle',
				$style
			);
		}
		...
		\DaisyBootstrap::core()->assets()->enqueueStyle( 'theme-styles', get_template_directory_uri() . '/style.css' );
	}
	...
	public function enqueueAdminAssets() {
		...
		\DaisyBootstrap::core()->assets()->enqueueScript(
			...
			\DaisyBootstrap::core()->assets()->getBundleUrl( 'admin', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \DaisyBootstrap::core()->assets()->getBundleUrl( 'admin', '.css' );
	...
	public function enqueueLoginAssets() {
		...
		\DaisyBootstrap::core()->assets()->enqueueScript(
			...
			\DaisyBootstrap::core()->assets()->getBundleUrl( 'login', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \DaisyBootstrap::core()->assets()->getBundleUrl( 'login', '.css' );
	...
	public function enqueueEditorAssets() {
		...
		\DaisyBootstrap::core()->assets()->enqueueScript(
			...
			\DaisyBootstrap::core()->assets()->getBundleUrl( 'editor', '.js' ),
			[ 'jquery' ],
			true
		);
	}
	...
	public function addFavicon() {
		\DaisyBootstrap::core()->assets()->addFavicon();
	}
