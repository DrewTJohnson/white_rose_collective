...
namespace DaisyBootstrap\Widgets;
...
class Carbon_Rich_Text_Widget extends Widget {
	...
	public function __construct() {
		$this->setup(
			'rich_text',
			__( 'Rich Text', 'daisy_bootstrap' ),
			__( 'Displays a block with title and WYSIWYG content.', 'daisy_bootstrap' ),
			array(
				Field::make( 'text', 'title', __( 'Title', 'daisy_bootstrap' ) ),
				Field::make( 'rich_text', 'content', __( 'Content', 'daisy_bootstrap' ) ),
			)
		);
	}
