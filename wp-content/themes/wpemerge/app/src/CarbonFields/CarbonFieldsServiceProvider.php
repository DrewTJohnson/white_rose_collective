...
namespace DaisyBootstrap\CarbonFields;
...
class CarbonFieldsServiceProvider implements ServiceProviderInterface {
	...
	protected function registerThemeOptions() {
		Container::make( 'theme_options', __( 'Theme Options', 'daisy_bootstrap' ) )
			->set_page_file( 'daisy_bootstrap-theme-options.php' )
			->add_fields( array(
				Field::make( 'text', 'crb_google_maps_api_key', __( 'Google Maps API Key', 'daisy_bootstrap' ) ),
				Field::make( 'header_scripts', 'crb_header_script', __( 'Header Script', 'daisy_bootstrap' ) ),
				Field::make( 'footer_scripts', 'crb_footer_script', __( 'Footer Script', 'daisy_bootstrap' ) ),
			) );
	}
	...
	protected function registerPostMeta() {
		/*
		Container::make( 'post_meta', __( 'Custom Data', 'daisy_bootstrap' ) )
	...
	protected function registerTermMeta() {
		/*
		Container::make( 'term_meta', __( 'Custom Data', 'daisy_bootstrap' ) )
	...
	protected function registerUserMeta() {
		/*
		Container::make( 'user_meta', __( 'Custom Data', 'daisy_bootstrap' ) )
			->add_fields( array(
				Field::make( 'image', 'crb_img' ),
			));
		*/
	...
	public function registerWidgets() {
		register_widget( \DaisyBootstrap\Widgets\Carbon_Rich_Text_Widget::class );
	}
}
